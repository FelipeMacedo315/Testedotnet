    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<IActionResult> DeleteUserAsync(Guid id)
        {
            try
            {
                ...
                return Ok(new { message = $"Usuario com id: {id} deletado com sucesso!" });

            }
            catch (Exception ex)
            {
                return StatusCode(500, new { message = $"Houve um erro e não foi possivel excluir o usuario com esse id:  {id}", error = ex.Message });
